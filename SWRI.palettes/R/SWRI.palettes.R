...
SWRI_palettes <- list(
  ...
  `festival` = SWRI_colours("deep blue", "purple grey", "SWRI pink", "dark yellow"),
  ...
  `meadow` = SWRI_colours("dark teal", "yellow", "blue", "mid purple"),
  `orchard` = SWRI_colours("mid purple", "SWRI pink", "amber", "dark teal"),
  `harbour` = SWRI_colours("purple grey", "deep blue", "dark teal", "yellow"),
  `firework` = SWRI_colours("SWRI pink", "yellow", "dark teal", "deep blue", "mid purple"),
  ...
  `tropic` = SWRI_colours("amber", "terracotta", "SWRI pink", "deep blue"),
  `pebble` = SWRI_colours("beige", "purple grey", "blue teal"),
  `summer` = SWRI_colours("deep blue", "yellow", "terracotta"),
  `prairie` = SWRI_colours("mid purple", "beige", "dark yellow", "dark teal"),
  `drift` = SWRI_colours("purple grey", "blue teal", "beige", "light grey"),
  `apple` = SWRI_colours("SWRI pink", "terracotta", "yellow", "dark teal"),
  `mosaic` = SWRI_colours("mid purple", "blue teal", "beige", "dark yellow", "terracotta"),
  ...
  `dune` = SWRI_colours("deep blue", "teal", "dark yellow", "terracotta"),
  `carnival` = SWRI_colours("blue", "SWRI purple", "SWRI pink", "orange"),
  `pollen` = SWRI_colours("SWRI pink", "dark yellow", "dark teal", "blue"),
  `parade` = SWRI_colours("SWRI pink", "orange", "dark teal", "deep blue", "SWRI purple"),
  `terrazzo` = SWRI_colours("terracotta", "dark yellow", "teal", "deep blue", "SWRI purple"),
  `harvest` = SWRI_colours("terracotta", "dark yellow", "deep blue", "purple grey"),
  `seaglass` = SWRI_colours("SWRI pink", "dark yellow", "teal", "blue", "purple grey"),
  `riviera` = SWRI_colours("SWRI purple", "blue teal", "yellow", "terracotta", "SWRI pink"),
  `wildflower` = SWRI_colours("SWRI pink", "terracotta", "teal", "blue", "SWRI purple"),
  `ember` = SWRI_colours("orange", "SWRI pink", "SWRI purple"),
  `saffron` = SWRI_colours("amber", "SWRI pink", "SWRI purple"),
  `autumn` = SWRI_colours("dark yellow", "SWRI pink", "SWRI purple"),
  `tidal` = SWRI_colours("SWRI pink", "SWRI purple", "blue teal"),
  `spring` = SWRI_colours("SWRI pink", "SWRI purple", "dark teal"),
  `winter` = SWRI_colours("SWRI pink", "SWRI purple", "deep blue"),
  `breeze` = SWRI_colours("SWRI pink", "SWRI purple", "blue"),
